"""Embed a generated chart as a figure with an auto-numbered caption.
...
The chart below shows quarterly revenue across our three regions.

![Quarterly revenue by region](revenue.png)

Revenue continued to climb through the year, with **AMER** leading the
pack. See the headcount chart for a complementary view.

## Headcount

![Headcount by team](headcount.png)

Both charts get independent ``Figure N`` numbers, regardless of any
tables that appear between or around them.

Table: Closing headline numbers.
